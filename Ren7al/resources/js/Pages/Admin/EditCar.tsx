...
interface EditCarPageProps {
    car: {
        data: Car;
    }; // Menerima data mobil dari controller
}

export default function EditCarPage({ car }: EditCarPageProps) {
    ...
    // Initialize form dengan data mobil yang ada
    ...
    console.log("EditCarPage data:", data);
    ...
    const removeImage = () => {
        setImagePreview(car.data.image || null); // Reset ke gambar asli
        setData("image", null);
    ...
    const handleSubmit = (e: FormEvent) => {
        ...
        put(route("admin.cars.update", car.data.id), {
            preserveScroll: true,
            onSuccess: () => {
                toast({
                    title: "Success",
                    description: `${data.brand} ${data.model} has been updated successfully.`,
                });
            },
            onError: () => {
                toast({
                    title: "Error",
                    description:
                        "There was an error updating the car.data. Please check the form for errors.",
                    variant: "destructive",
                });
            },
        });
            ...
            <div>
                <div className="mb-6 flex items-center">
                    ...
                    <h1 className="text-2xl font-bold">
                        Edit Mobil: {car.data.brand} {car.data.model}
                    </h1>
                </div>

                <form onSubmit={handleSubmit} className="space-y-8">
                    <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
                        {/* Main Form - sama seperti AddCar tapi dengan data yang sudah diisi */}
